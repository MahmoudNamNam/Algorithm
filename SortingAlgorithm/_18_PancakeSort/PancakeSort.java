package Algorithm.SortingAlgorithm._18_PancakeSort;
...
class PancakeSort {
	...
	static int pancakeSort(int arr[], int n) {
		...
		for (int curr_size = n; curr_size > 1; --curr_size) {
			...
			if (mi != curr_size - 1) {
				// To move it to the end, first move the maximum number to the beginning
				flip(arr, mi);
	...
	/* Driver function to check for the above functions */
